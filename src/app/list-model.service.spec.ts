...
beforeEach(() => 
        testService.model =  [{header:'List 1',listUid:'A', listItems:[
           {viewText:'something1',uid:'0_0'},
           {viewText:'someother2',uid:'0_1'},
           {viewText:'some3',uid:'0_2'}
          ]},
          {header:'List 2',listUid:'B', listItems:[
           {viewText:'something1',uid:'1_0'},
           {viewText:'someother2',uid:'1_1'},
           {viewText:'some3',uid:'1_2'}
          ]}]
          )
